    ...
    return (
        <div className="carousel w-full">
            <div id="slide1" className="carousel-item relative w-full h-screen">
                ...
                <div className="absolute flex items-center rounded-xl left-0 top-0 bg-gradient-to-r h-full from-[#151515] to-[rgba(21, 21, 21, 0.00) 100%)]">
                    <div className='text-white space-y-7 w-1/2 pl-12'>
                        <h2 className='text-6xl font-bold leading-snug'>Affordable Price For Car Servicing</h2>
